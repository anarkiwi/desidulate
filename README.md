...
desidulate is a suite of command line of "decompiler" tools for transcribing and analyzing [C64/SID](https://en.wikipedia.org/wiki/MOS_Technology_6581) music, based on Pandas.
